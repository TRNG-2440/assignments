...
bookings = [
    (1001, '  aarav mehta  ', 'SKY', 'BLR-DEL', 8500.0, 15.0, '2026-01-05', '2026-02-10', 'Bengaluru', 'Delhi', 'Economy', None, 'Meal|WiFi', 'CONFIRMED', 4.5, 'Card'),
    (1002, 'DIYA IYER', 'NVA', 'DEL-BOM', 7200.0, 20.0, '2026-01-08', '2026-02-12', 'Delhi', 'Mumbai', 'Economy', 500.0, 'Meal|Priority Boarding', 'CONFIRMED', 4.2, 'UPI'),
    (1003, 'kabir khan', 'ORB', 'MAA-HYD', 6400.0, 10.0, '2026-01-10', '2026-02-15', 'Chennai', 'Hyderabad', 'Economy', 300.0, 'WiFi', 'COMPLETED', 3.8, 'Card'),
    (1004, 'Meera Das', 'ZEP', 'BOM-GOA', 5100.0, 7.0, '2026-01-12', '2026-02-18', 'Mumbai', 'Goa', 'Economy', None, 'Meal', 'CANCELLED', None, 'NetBanking'),
    (1005, '  nisha roy', 'LUM', 'CCU-DEL', 9300.0, 22.0, '2026-01-15', '2026-02-20', 'Kolkata', 'Delhi', 'Premium Economy', 750.0, 'Meal|WiFi|Lounge', 'CONFIRMED', 4.7, 'UPI'),
    (1006, 'ARJUN NAIR', 'SKY', 'BLR-MAA', 5800.0, 12.0, '2026-01-18', '2026-02-21', 'Bengaluru', 'Chennai', 'Economy', 250.0, 'Meal|WiFi', 'COMPLETED', 4.0, 'Card'),
    (1007, 'sana sheikh', 'NVA', 'HYD-BLR', 6900.0, 18.0, '2026-01-20', '2026-02-23', 'Hyderabad', 'Bengaluru', 'Economy', None, 'Priority Boarding', 'CONFIRMED', 4.1, 'Wallet'),
    (1008, 'Rohan  Sen', 'ORB', 'DEL-JAI', 4300.0, 5.0, '2026-01-22', '2026-02-25', 'Delhi', 'Jaipur', 'Economy', 200.0, None, 'COMPLETED', 3.6, 'UPI'),
    (1009, '  priya kapoor  ', 'ZEP', 'BLR-DEL', 12500.0, 25.0, '2026-01-25', '2026-03-01', 'Bengaluru', 'Delhi', 'Business', 1000.0, 'Meal|WiFi|Lounge|Priority Boarding', 'CONFIRMED', 4.9, 'Card'),
    (1010, 'VIKAS JAIN', 'LUM', 'DEL-BOM', 11800.0, 24.0, '2026-01-28', '2026-03-03', 'Delhi', 'Mumbai', 'Business', None, 'Meal|Lounge', 'CONFIRMED', 4.4, 'NetBanking'),
    (1011, 'ananya bose', 'SKY', 'MAA-HYD', 6100.0, 9.0, '2026-02-01', '2026-03-05', 'Chennai', 'Hyderabad', 'Economy', 350.0, 'Meal', 'COMPLETED', 4.0, 'UPI'), 
    (1012, 'Karan Malhotra', 'NVA', 'BOM-GOA', 5400.0, 8.0, '2026-02-02', '2026-03-06', 'Mumbai', 'Goa', 'Economy', None, 'Meal|WiFi', 'CONFIRMED', 3.9, 'Card'),
    (1012, 'Karan Malhotra', 'NVA', 'BOM-GOA', 5400.0, 8.0, '2026-02-02', '2026-03-06', 'Mumbai', 'Goa', 'Economy', None, 'Meal|WiFi', 'CONFIRMED', 3.9, 'Card'),
    (1013, '  ishita paul', 'ORB', 'CCU-DEL', 8700.0, 16.0, '2026-02-04', '2026-03-08', 'Kolkata', 'Delhi', 'Premium Economy', 600.0, 'Meal|WiFi', 'COMPLETED', 4.3, 'Wallet'),
    (1014, 'MOHAN RAO', 'ZEP', 'BLR-MAA', 5900.0, 14.0, '2026-02-06', '2026-03-10', 'Bengaluru', 'Chennai', 'Economy', 300.0, 'Meal', 'CONFIRMED', 4.1, 'UPI'),
    (1015, 'leena joseph', 'LUM', 'HYD-BLR', 7600.0, 19.0, '2026-02-08', '2026-03-12', 'Hyderabad', 'Bengaluru', 'Premium Economy', None, 'WiFi|Priority Boarding', 'CANCELLED', 3.5, 'Card'),
    (1016, 'Dev Patel', 'SKY', 'DEL-JAI', 4500.0, 6.0, '2026-02-10', '2026-03-14', 'Delhi', 'Jaipur', 'Economy', 150.0, 'Meal', 'COMPLETED', 3.7, 'Cash'),
    (1017, '  kavya reddy  ', 'NVA', 'BLR-DEL', 8500.0, 15.0, '2026-02-12', '2026-03-16', 'Bengaluru', 'Delhi', 'Economy', 500.0, 'Meal|WiFi', 'CONFIRMED', 4.6, 'UPI'),
    (1018, 'RAHUL VERMA', 'ORB', 'DEL-BOM', 7200.0, 20.0, '2026-02-14', '2026-03-18', 'Delhi', 'Mumbai', 'Economy', None, 'Meal|Priority Boarding', 'CONFIRMED', 4.0, 'Card'),
    (1019, 'simran kaur', 'ZEP', 'MAA-HYD', 6400.0, 11.0, '2026-02-16', '2026-03-20', 'Chennai', 'Hyderabad', 'Economy', 250.0, 'WiFi', 'COMPLETED', 3.8, 'Wallet'),
    (1020, 'Naveen  Kumar', 'LUM', 'BOM-GOA', 5200.0, 7.5, '2026-02-18', '2026-03-22', 'Mumbai', 'Goa', 'Economy', None, 'Meal', 'CONFIRMED', 4.2, 'NetBanking'),
    (1021, '  tara singh', 'SKY', 'CCU-DEL', 9400.0, 21.0, '2026-02-20', '2026-03-24', 'Kolkata', 'Delhi', 'Premium Economy', 700.0, 'Meal|WiFi|Lounge', 'CONFIRMED', 4.8, 'Card'),
    (1022, 'AMAN GUPTA', 'NVA', 'BLR-MAA', 5800.0, 12.0, '2026-02-22', '2026-03-26', 'Bengaluru', 'Chennai', 'Economy', 200.0, 'Meal|WiFi', 'COMPLETED', 3.9, 'UPI'),
    (1023, 'pooja shah', 'ORB', 'HYD-BLR', 7000.0, 17.0, '2026-02-24', '2026-03-28', 'Hyderabad', 'Bengaluru', 'Economy', None, 'Priority Boarding', 'CONFIRMED', 4.1, 'Card'),
    (1024, 'Suresh Menon', 'ZEP', 'DEL-JAI', 4400.0, 5.5, '2026-02-26', '2026-03-30', 'Delhi', 'Jaipur', 'Economy', 180.0, None, 'COMPLETED', 3.6, 'Cash'),
    (1025, '  riya chatterjee  ', 'LUM', 'BLR-DEL', 12700.0, 26.0, '2026-03-01', '2026-04-02', 'Bengaluru', 'Delhi', 'Business', 1100.0, 'Meal|WiFi|Lounge|Priority Boarding', 'CONFIRMED', 4.9, 'Card'),
    (1026, 'ADITYA SINGH', 'SKY', 'DEL-BOM', 11900.0, 23.0, '2026-03-03', '2026-04-04', 'Delhi', 'Mumbai', 'Business', None, 'Meal|Lounge', 'CONFIRMED', 4.5, 'NetBanking'),
    (1027, 'neha pillai', 'NVA', 'MAA-HYD', 6200.0, 10.0, '2026-03-05', '2026-04-06', 'Chennai', 'Hyderabad', 'Economy', 300.0, 'Meal', 'COMPLETED', 4.0, 'UPI'),
    (1028, 'Harish  Babu', 'ORB', 'BOM-GOA', 5500.0, 8.0, '2026-03-07', '2026-04-08', 'Mumbai', 'Goa', 'Economy', None, 'Meal|WiFi', 'CONFIRMED', 3.8, 'Card'),
    (1029, '  zoya ali', 'ZEP', 'CCU-DEL', 8800.0, 16.0, '2026-03-09', '2026-04-10', 'Kolkata', 'Delhi', 'Premium Economy', 650.0, 'Meal|WiFi', 'COMPLETED', 4.4, 'Wallet'),
    (1030, 'MANOJ DAS', 'LUM', 'BLR-MAA', 6000.0, 13.0, '2026-03-11', '2026-04-12', 'Bengaluru', 'Chennai', 'Economy', 280.0, 'Meal', 'CONFIRMED', 4.0, 'UPI'),
    (1031, 'swati nair', 'SKY', 'HYD-BLR', 7700.0, 18.0, '2026-03-13', '2026-04-14', 'Hyderabad', 'Bengaluru', 'Premium Economy', None, 'WiFi|Priority Boarding', 'CANCELLED', 3.4, 'Card'),
    (1032, 'Ritesh Jain', 'NVA', 'DEL-JAI', 4600.0, 6.0, '2026-03-15', '2026-04-16', 'Delhi', 'Jaipur', 'Economy', 160.0, 'Meal', 'COMPLETED', 3.7, 'Cash'),
    (1033, '  lavanya krishnan ', 'ORB', 'BLR-DEL', 8600.0, 15.0, '2026-03-17', '2026-04-18', 'Bengaluru', 'Delhi', 'Economy', 450.0, 'Meal|WiFi', 'CONFIRMED', 4.5, 'UPI'),
    (1034, 'OM PRAKASH', 'ZEP', 'DEL-BOM', 7300.0, 20.0, '2026-03-19', '2026-04-20', 'Delhi', 'Mumbai', 'Economy', None, 'Meal|Priority Boarding', 'CONFIRMED', 4.1, 'Card'),
    (1035, 'farah khan', 'LUM', 'MAA-HYD', 6500.0, 11.0, '2026-03-21', '2026-04-22', 'Chennai', 'Hyderabad', 'Economy', 320.0, 'WiFi', 'COMPLETED', 3.9, 'Wallet'),
    (1036, '  gautam roy', 'UNK', 'BLR-DEL', 8100.0, 14.0, '2026-03-23', '2026-04-24', 'Bengaluru', 'Delhi', 'Economy', None, 'Meal', 'CONFIRMED', None, None)]
...
airlines = [
    ('SKY', 'SkyBridge Airways', 'Bengaluru', 'Full Service'),
    ('NVA', 'NovaJet', 'Delhi', 'Low Cost'),
    ('ORB', 'Orbit Air', 'Mumbai', 'Low Cost'),
    ('ZEP', 'Zephyr Airlines', 'Hyderabad', 'Full Service'),
    ('LUM', 'Lumina Flights', 'Chennai', 'Hybrid'),
    ('PAC', 'Pacifica Air', 'Kochi', 'Regional')
    ]
...
routes = [
    ('BLR-DEL', 'Bengaluru to Delhi', 'North-South', 1740, 165),
    ('DEL-BOM', 'Delhi to Mumbai', 'West', 1150, 130),
    ('MAA-HYD', 'Chennai to Hyderabad', 'South', 630, 75),
    ('BOM-GOA', 'Mumbai to Goa', 'West', 435, 65),
    ('CCU-DEL', 'Kolkata to Delhi', 'East-North', 1305, 145),
    ('BLR-MAA', 'Bengaluru to Chennai', 'South', 290, 60),
    ('HYD-BLR', 'Hyderabad to Bengaluru', 'South', 500, 70),
    ('DEL-JAI', 'Delhi to Jaipur', 'North', 240, 55)
    ]

new_bookings = [
    (1037, '  tanvi desai', 'SKY', 'BOM-GOA', 5600.0, 9.0, '2026-03-25', '2026-04-26', 'Mumbai', 'Goa', 'Economy', 250.0, 'Meal|WiFi', 'CONFIRMED', 4.2, 'UPI'),
    (1038, 'YASH AGARWAL', 'NVA', 'CCU-DEL', 9000.0, 18.0, '2026-03-27', '2026-04-28', 'Kolkata', 'Delhi', 'Premium Economy', None, 'Meal|Lounge', 'CONFIRMED', 4.6, 'Card'),
    (1039, 'maria jose', 'ORB', 'BLR-MAA', 6050.0, 12.0, '2026-03-29', '2026-04-30', 'Bengaluru', 'Chennai', 'Economy', 200.0, 'Meal', 'COMPLETED', 4.0, 'Wallet'),
    (1040, '  vivek sharma  ', 'ZEP', 'HYD-BLR', 7800.0, 17.0, '2026-03-31', '2026-05-02', 'Hyderabad', 'Bengaluru', 'Premium Economy', 400.0, 'WiFi|Priority Boarding', 'CONFIRMED', 4.3, 'NetBanking')
    ]
...
# TODO Question 2
# Write your PySpark solution below.
bookings_df.select("booking_id", "passenger_name", "airline_code", "route_code", "ticket_amount").show()
...
# TODO Question 3
# Write your PySpark solution below.
bookings_df.select(F.col("passenger_name"), F.col("ticket_amount")).show()
...
bookings_df.select(
    ...
    F.initcap(F.col("passenger_name")).alias("capitalized_name")
).show()
...
# Write your PySpark solution below.
bookings_df.select(
    F.substring(F.trim(F.col("passenger_name")), 1, 5).alias("first_five_char")
).show()
...
# Write your PySpark solution below.
bookings_df.select(
    F.concat(F.lit("BOOK-"), F.col("booking_id").cast("string")).alias("booking_code")
).show()
...
# Write your PySpark solution below.
bookings_df.select(
    F.regexp_replace(F.col("passenger_name"), r"\s+", " ").alias("passenger_name")
).show(truncate=False)
...
# Write your PySpark solution below.
bookings_df.select(
    F.round(F.col("ticket_amount") / 3, 2).alias("ticket_round"),
    F.ceil(F.col("ticket_amount") / 3).alias("ticket_ceiling"),
    F.floor(F.col("ticket_amount") / 3).alias("ticket_floor")
).show()
...
# Write your PySpark solution below.
bookings_df.select(
    F.abs(F.col("ticket_amount") - F.lit(7000)).alias("abs_diff")
).show()
...
# Write your PySpark solution below.
bookings_df.select(
    F.pow(F.col("baggage_kg"), 2).alias("baggage_sq")
).show()
...
bookings_df.select(
    ...
    (
        F.col("ticket_amount")
        - F.coalesce(F.col("promo_discount"), F.lit(0))
    ).alias("fare_after_flat_discount"),
    (F.col("baggage_kg") * 2).alias("doubled_baggage"),
    F.when(F.col("baggage_kg") == 0, F.lit(None))
    .otherwise(F.col("ticket_amount") / F.col("baggage_kg"))
    .alias("fare_per_kg"),
).show()
...
# TODO Question 31
# Write your PySpark solution below.
bookings_df.fillna({"promo_discount": 0}).show()
...
# TODO Question 32
# Write your PySpark solution below.
bookings_df.dropna(subset = ["satisfaction_score"]).show()
