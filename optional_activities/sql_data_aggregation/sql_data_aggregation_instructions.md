...
*The schema for this exercise is provided in the accompanying file `sales_data_schema.sql`. You do not need to modify that file — simply run it to set up your database before attempting the queries below.*
...
Using the schema above, write a SQL query for each of the following:
