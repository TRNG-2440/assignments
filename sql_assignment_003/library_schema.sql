...
CREATE TABLE library.books (
    ...
    author INTEGER NOT NULL REFERENCES library.authors(author_id),
    publication INTEGER NOT NULL,
    page_count INTEGER NOT NULL
);

--POPULATE AUTHORS
INSERT INTO library.authors (author_id, author_name) VALUES
...
--POPULATE BOOKS
INSERT INTO library.books (book_id, title, author, publication, page_count) VALUES
