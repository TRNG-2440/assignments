...
-- Run this code if values need to be added
/*
insert into library.authors(author_id, author_name)
values
...
insert into library.books(book_id, title, author_id, publication, page_count)
values
...
insert into library.books(author_id, title, publication, page_count)
values(1002, 'Down and Out in Paris and London', 1933, 230);