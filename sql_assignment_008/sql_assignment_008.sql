...
INSERT INTO Team (team_id, team_name, state_id, sport_id) VALUES
...
INSERT INTO Player (player_id, team_id, player_name, player_salary) VALUES
...
-- Get players who play football with a salary over 200000
SELECT p.player_name, p.player_salary, s.sport_name
FROM Player p
...
-- Get sport with the highest paid player.
...
-- Get all players whose name starts with the letter the letter 'j' followed immediately by the letter 'o'. 
